...
import com.example.fitnessapp2.ml.Modelbronchiectasis
import org.tensorflow.lite.DataType
import org.tensorflow.lite.support.tensorbuffer.TensorBuffer
import java.nio.ByteBuffer

class Bronchiectasis : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bronchiectasis)
        ...
        button.setOnClickListener(View.OnClickListener {
            ...
            val model = Modelbronchiectasis.newInstance(this)
...
// Runs model inference and gets result.
            ...
            tv.setText("You are likely to have bronchiectasis")
