...
import com.example.fitnessapp2.ml.Modelprediabetes
import org.tensorflow.lite.DataType
import org.tensorflow.lite.support.tensorbuffer.TensorBuffer
import java.nio.ByteBuffer

class Prediabetes : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_prediabetes)
        ...
        button.setOnClickListener(View.OnClickListener {
            ...
            val model = Modelprediabetes.newInstance(this)
...
// Runs model inference and gets result.
            ...
            tv.setText("You are not likely to have Prediabetes");
